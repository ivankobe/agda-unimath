...
record
  ...
  globe-Synthetic-Category-Theory :
    (n : ℕ) → UU l
  globe-Synthetic-Category-Theory =
      globe-Reflexive-Globular-Type logos-Synthetic-Category-Theory
  ...
  id-3-iso-Synthetic-Categoriy-Theory {C} {D} {f} {g}  α =
  ...
  4-iso-reflexive-globular-type-Synthetic-Category-Theory φ ψ =
    iso-reflexive-globular-type-Synthetic-Category-Theory
      ( extension-sphere-Reflexive-Globular-Type _ _
        ( extension-sphere-Reflexive-Globular-Type _ _
          ( extension-sphere-Reflexive-Globular-Type _ _
